 ...
 */
public class ListViewScrollingOff extends ListView
{
    ...
    public ListViewScrollingOff(Context context) {
        super(context);
    }

    public ListViewScrollingOff(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ListViewScrollingOff(Context context, AttributeSet attrs, int defStyle) {
