 ...
 *
 */
public class VideoWebChromeClient extends WebChromeClient implements OnPreparedListener, OnCompletionListener, OnErrorListener
{
     ...
     */
    public VideoWebChromeClient(ViewGroup activityVideoView)
    {
     ...
     */
    public VideoWebChromeClient(ViewGroup activityVideoView, View loadingView)
    {
        this.activityVideoView = activityVideoView;
     ...
     */
    public VideoWebChromeClient(ViewGroup activityVideoView, View loadingView, WebView webView)
    {
