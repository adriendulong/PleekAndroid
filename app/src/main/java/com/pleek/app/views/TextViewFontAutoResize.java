...
public class TextViewFontAutoResize extends AutofitTextView {

    private static Map<String, Typeface> fonts = new HashMap<String, Typeface>();

    public TextViewFontAutoResize(Context context) {
        super(context);
    }

    public TextViewFontAutoResize(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public TextViewFontAutoResize(Context context, AttributeSet attrs, int defStyle) {
