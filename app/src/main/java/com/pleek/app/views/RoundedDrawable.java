...
public class RoundedDrawable extends Drawable {
   ...
   * @return the corner radius of the specified {@link com.pleek.app.views.RoundedDrawable.Corner}.
   */
   ...
   * @return the {@link com.pleek.app.views.RoundedDrawable} for chaining.
   */
